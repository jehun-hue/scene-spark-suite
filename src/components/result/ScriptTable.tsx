...
import { MessageSquare, MoreHorizontal, Terminal, Type, Timer, Tv2, Image as ImageIcon } from "lucide-react";
              ...
              {scriptItems.map((item) => (
                <TableRow key={item.id} className="border-b border-white/5 hover:bg-white/5 transition-colors group">
                  ...
                  <TableCell className="text-right">
                    <div className="w-14 h-9 ml-auto bg-white/5 rounded-lg border border-white/5 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                       <ImageIcon className="w-4 h-4 text-gray-700 opacity-30" />
                    </div>
                  </TableCell>
                </TableRow>
              ))}
